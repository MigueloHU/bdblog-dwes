  ...
  <main class="flex-grow-1">
    ...
    <div class="container py-4">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-outline-secondary" href="index.php?controller=entrada&action=listar">
          Volver
        </a>
      </div>
      ...
      <?php $action = ($modo === 'editar') ? 'actualizar' : 'guardar'; ?>

      <!-- IMPORTANTE: novalidate para CKEditor -->
      <form class="card shadow-sm p-4"
        ...
        <div class="mb-3">
          ...
          <textarea id="descripcion"
            class="form-control"
            name="descripcion"
            rows="8"><?= $entrada['descripcion'] ?></textarea>
        </div>
    ...
    <!-- CKEditor: UNA sola carga y al final -->
